            ...
            if k in input_names_from_model:
                ...
                if not all_input_names:
                    ...
                    for inp in all_input_names:
                        #if inp == 'learning_rate_decay_cond/Merge':
                        #    import pdb
                        #    pdb.set_trace()
                                ...
                                if tensor_from_model.shape.dims is None:
                                    ...
                                    if '?' in valid_tensor_shapes:
                                        ...
                                        if t1 in node_output_shape:
                                            ...
                                            if t1.split('/')[-1] == 'BroadcastGradientArgs': # just an axis number
                                                tensor_shape_result = '1x1'
                                            else:
                                                ...
                                                if t1 in self.cf_temp:
                                                    ...
                                                    if cf_cand in node_output_shape:
                                                        ...
                                                        ops_not_in_metadata.add(t1)#ops_not_in_metadata.append('t1=' + t1 + '; ' + 'cf_cand = self.cf_temp[t1] = ' + cf_cand + ' was not in node_output_shape')
                                   
                                                else:
                                                    ops_not_in_metadata.add(t1)#ops_not_in_metadata.append('at all not found - t1=' + t1 + '  was not in node_output_shape, INP: ' + inp + '; k : ' + k)
                                    else:     
                                        if len(valid_tensor_shapes) == 1:
                                            valid_tensor_shapes.append('1')
