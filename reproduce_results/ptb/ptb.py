...
# sudo python3 ptb_word_lm.py --data_path=$HOME/work_april/models/tutorials/rnn/ptb/simple-examples/data/ --model=small
# /home/ndr/work_april/models/tutorials/rnn/ptb/simple-examples
...
def run_epoch(session, model, eval_op=None, verbose=False):
  ...
  opts = (option_builder.ProfileOptionBuilder(tf.profiler.ProfileOptionBuilder.time_and_memory())
          ...
          .with_step(-1)
          .with_file_output('/tmp/timeline.txt')
          #.with_timeline_output('/tmp/timeline.json')
          .build())
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    with tf.train.MonitoredTrainingSession(config=config_proto) as session:
